...
/**
 * The exportable body of a voucher (header + entries table + narration) plus
 * the actions that operate on it. A client component because Print/CSV/JPG
 * need a DOM ref to capture — everything it renders is pre-fetched server
 * data passed straight through as props, not fetched here.
 */
